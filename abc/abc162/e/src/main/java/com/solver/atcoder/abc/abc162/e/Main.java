package com.solver.atcoder.abc.abc162.e;
...
public class Main {
  ...
  static void solve(InputStream is, PrintStream os) {
    ...
    for (long i = 1; i <= k; i++) {
      ans += (modular.pow(k / i, n) - modular.pow(k / i - 1, n)) * i;
      ans += (modular.pow(k - i + 1, n) - modular.pow(k - k / i - i + 1, n) - modular.pow(k / i - 1, n)) * 1;
      ans %= MOD;
    }
